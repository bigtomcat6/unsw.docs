...
> In Week 0, you only need to prepare Section 1. Follow the steps to learn how to build and simulate circuits. You are also welcome to prepare other sections as all the lab questions require significant preparation.

<HMoodleLink type='avi' md5='f8c3dcc7a743301eeaf3e86219a0dc0c' >LTSpice guidance video</HMoodleLink>

>Many of the lab exercises require the use of LTSpice, which you can download [here](https://www.analog.com/en/design-center/design-tools-and-calculators/ltspice-simulator.html) to work at home. You can also access LTSpice in myAccess: <https://www.myaccess.unsw.edu.au/applications/ltspice>.
>
> The computers in your lab already have LTSpice installed, and you can use it during lab hours.
>
> Laboratory demonstrator Timothy Hanrahan created a video (click link above for direct download) to help you install LTSpice in Mac and show you how to conduct simulations using LTSpice.

The recommended book for ELEC2134 is the same as the recommended book for ELEC1111 (C. K. Alexander and M. N. O. Sadiku, Fundamentals of Electric Circuits, 7th ed., New York, NY, USA: McGraw-Hill, 2017).

Specific sets of problems from the book and quizzes can be accessed online via McGraw Hill Connect using the link below (IMPORTANT NOTE: you are allowed to access the quizzes and review exercises even if you do not purchase the book). There are also specific links to each of the activities under each activity for your convenience.

If you want to purchase the book, please do so via McGraw Hill Connect, since it should be the most economical option ($40). Instructions to Register and purchase the book can be found below. 
...
- <HMoodleLink type='pdf' md5='92568b5ef229c6c360728012ea38f18f'>AC Review 1 - Alternating Current</HMoodleLink>
    - <HMoodleLink type='pdf' md5='3b70bd262a4dbe006899372a27a33801'>AC Review 1 - Solutions to Alternating Current exercises</HMoodleLink>
...
- Week1 - AC Review and Simulation Problem Sheet (below)
- Problems 9.11, 9.31, 9.33, 9.59, 9.61, 9.63, 9.77, 9.91, 10.1, 10.3, 10.25 (Problems with fully worked solutions accessible via McGraw Hill Connect - link below. To see step-by-step solutions, click 'Submit' and 'Show correct answer' - you do not need to enter any value to submit and you do not need to worry about the mark, since these problems are only to practice)
...
- Examples and exercises in the lecture slides.
- Week1 - Transfer Function and AC Power Problem Sheet (below)
- Practice Problems 11.1, 11.2, 11.3, 11.4, 11.5, 11.9, 11.11, 11.12, 11.15 (problems with numerical solutions from textbook)
- Problems 11.1, 11.3, 11.5, 11.7, 11.13, 11.15, 11.39, 11.41, 11.45, 11.47, 11.49, 11.51, 11.53, 11.69, 11.71, 11.73, 11.75 (Problems with fully worked solutions accessible via McGraw Hill Connect - link below. To see step-by-step solutions, click 'Submit' and 'Show correct answer' - you do not need to enter any value to submit and you do not need to worry about the mark, since these problems are only to practice).

---

- <HMoodleLink type='pdf' md5='459023cd1a105879d7271f58003a57ba'>Week1 - AC Power Problem Sheet</HMoodleLink>
    - <HMoodleLink type='pdf' md5='e0909c2c345f8a1ee859fe6e99fff5c0'>Week1 - AC Power Problem Sheet - Worked Solutions</HMoodleLink>
- <HMoodleLink type='McGrawHill' src='https://moodle.telt.unsw.edu.au/mod/lti/launch.php?id=7041801&triggerview=0'>Week 1 – AC Power</HMoodleLink>
